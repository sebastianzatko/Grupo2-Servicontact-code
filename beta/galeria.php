    ...
    <div class="tab-pane fade in" id="tab2">
		...
		<div class="galeria"> 
          ...
          <div class="tz-gallery">
			<?php
				foreach($fotos as $foto){
					echo "<div class='gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-12 filter ".$foto[2]."'> <img src='".$foto[1]."' id='".$foto[0]."' ></div>";
				}
							...
							<label class="col-sm-3 control-label">
							 ...
							 <div class="col-xs-12 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2"> 
								<span class="btn btn-default btn-file">
									<input id="input-2" class=" col-xs-12 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2" name="upload[]" type="file" class="file" multiple data-show-upload="true" data-show-caption="true">
								</span>
							</div>
						</div>
						<div class="form-group" style="margin-left:0px">
