...
include_once('cdata/datasearch.php');
	class b_Search{
		...
		public function buscarServiciosFiltrados($arrayServicios,$pronvincia,$ciudad){
			$busqueda=new d_search;
			if($resultados=$busqueda->buscarServiciosConFiltro($arrayServicios,$pronvincia,$ciudad)){
				$resultadosfiltrados=[];
				foreach($resultados as $resultado){
