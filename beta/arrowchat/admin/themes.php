...
",  get_var('template_data'));
	...
	{
		$file = '<?php $bar_background = "' . get_var('bar_background') . '";';
		$file .= '$bar_border = "' . get_var('bar_border') . '";';
		$file .= '$bar_text = "' . get_var('bar_text') . '";';
		$file .= '$bar_hover = "' . get_var('bar_hover') . '";';
		$file .= '$window_title = "' . get_var('window_title') . '";';
		$file .= '$window_title_focus = "' . get_var('window_title_focus') . '";';
		$file .= '$window_title_hover = "' . get_var('window_title_hover') . '";';
		$file .= '$window_text = "' . get_var('window_text') . '";';
